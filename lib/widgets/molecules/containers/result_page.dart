              ...
              child: BMICardView(
                ...
                cardChild: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                    children:[
                      Text(calculateBMI.getResult(calculateBMI.getCalculation()).toUpperCase(),style: TextStyle(
                        color: Constants.appColorBrownRed,
                        fontSize: 28.0,
                        fontWeight: FontWeight.bold,
                      ),),
                      Text(calculateBMI.getCalculation().toStringAsFixed(1),style: TextStyle(
                        fontSize: 100.0,
                        fontWeight: FontWeight.bold,
                      ),),
                      Text(calculateBMI.getInterpretation(calculateBMI.getCalculation()),
                        style: TextStyle(
                          fontSize: 22.0,
                          fontWeight: FontWeight.bold,
                        ),
